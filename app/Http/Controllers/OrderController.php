...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        ->orderBy('status', 'ASC')
        ->paginate(3);
        return view('Backends.Order.select', ['orders' => $orders]);
    }
    ...
    public function show($idorder)
    {
        ...
        return view('Backends.Order.update', ['order'=>$order]);
    }
    ...
    public function edit($idorder)
    {
        ...
        return view('Backends.Order.details', ['orders' => $orders]);
    }
    ...
    {
        $order = Order::where('idorder', $idorder)->first();
        $kembali = $request->bayar - $order->total;
